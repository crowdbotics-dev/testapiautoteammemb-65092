...
## Project Structure
    ...
    ├── testapiautoteammemb_65092  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_65092`
...
2. Clone this repo and `cd testapiautoteammemb_65092`
